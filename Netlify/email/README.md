# Cleaning Insurance Direct — Instantly email creatives

Hosted on **cleaninginsurancedirect.com** via `cleaning-pdf-backend/Netlify/email/`.
...
| **JPEG** | `CID_Cleaning_Creative.jpg` |
| **Instantly HTML** | `instantly_step3.html` |
| **Public JPEG URL** | https://cleaninginsurancedirect.com/email/archive/2026-08-connect-v1/CID_Cleaning_Creative.jpg |
...
node scripts/generate-instantly-email.mjs --segment cleaning --version 2026-08-connect-v1
node scripts/extract-creative-jpg.mjs \
  --input ~/Downloads/CID_Creative_Cleaning_Embedded.html \
  --output ~/GitHub/cleaning-pdf-backend/Netlify/email/archive/2026-08-connect-v1/CID_Cleaning_Creative.jpg
```
